...
function renderPatchChat() {
	...
	React.render(
		React.createElement(PatchChatBox, null),
		document.getElementById( 'patchchatbox' )
	);
}


var PatchChatBox = React.createClass( {displayName: "PatchChatBox",
	...
	render: function() {
		return (
			React.createElement("div", null, 
				...
				React.createElement(PatchChatBody, {data: this.state.data})
			)
		);
	}
} );